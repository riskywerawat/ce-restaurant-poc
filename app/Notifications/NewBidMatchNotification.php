...
class NewBidMatchNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $contents = view('emails.pdf.matched_bid', compact('transaction'))->render();
...
//        Storage::makeDirectory('pdf/'.$date);
        ...
        return (new MailMessage)
            ...
            ->line('You bid request has been matched.')
