        ...
        <div class="fixed inset-0 flex z-40">
            ...
            <div
                ...
                <div class="mt-5 flex-1 h-0 overflow-y-auto">
                    ...
                    @endcan
                        @can('manage', \App\Models\Transaction::class)
                            <a href="{{ route('dashboard.transactions.index') }}" class="mt-1 group nav-link-mobile {{ navLinkClass('dashboard.transactions', 'active', 'inactive') }}">
                                <svg class="mr-4 h-6 w-6 {{ navLinkClass('dashboard.transactions', 'text-blue-300', 'text-blue-400') }} group-hover:text-blue-300 group-focus:text-blue-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                    <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd" />
                                </svg>
                                {{ __('dashboard/nav.transactions') }}
                            </a>
                        @endcan
                        ...
                        @can('manage', \App\Models\SiteSetting::class)
                            <a href="{{ route('dashboard.site_settings.edit') }}" class="mt-1 group nav-link-mobile {{ navLinkClass('dashboard.site_settings', 'active', 'inactive') }}">
                                <svg class="mr-4 h-6 w-6 {{ navLinkClass('dashboard.site_settings', 'text-blue-300', 'text-blue-400') }} group-hover:text-blue-300 group-focus:text-blue-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                {{ __('dashboard/nav.site_settings') }}
                            </a>
                        @endcan
        ...
        <div class="flex flex-col w-64">
            ...
            <div class="h-0 flex-1 flex flex-col overflow-y-auto">
                ...
                <nav class="flex-1 px-2 py-4 dark:bg-slate-800">
                    ...
                    @endcan
                    @can('manage', \App\Models\Transaction::class)
                    <a href="{{ route('dashboard.transactions.index') }}" class="mt-1 group nav-link {{ navLinkClass('dashboard.transactions', 'active', 'inactive') }}">
                        <svg class="mr-3 h-6 w-6 {{ navLinkClass('dashboard.transactions', 'text-blue-300', 'text-blue-400') }} group-hover:text-blue-300 group-focus:text-blue-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                            <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd" />
                        </svg>
                        {{ __('dashboard/nav.transactions') }}
                ...
                @endcan
                    ...
                    @endcan
                    @can('manage', \App\Models\SiteSetting::class)
                        <a href="{{ route('dashboard.site_settings.edit') }}" class="mt-1 group nav-link {{ navLinkClass('dashboard.site_settings', 'active', 'inactive') }}">
                            <svg class="mr-3 h-6 w-6 {{ navLinkClass('dashboard.site_settings', 'text-blue-300', 'text-blue-400') }} group-hover:text-blue-300 group-focus:text-blue-300 transition ease-in-out duration-150" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            {{ __('dashboard/nav.site_settings') }}
