                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            class="absolute inset-0 transition duration-150 ease-in-out border border-transparent"
                            :class="[
                              theme.picker.rounded,
                              possibleDate(date)
                          ...
                          >
                            <div
                              :class="[
                                (holidayDate(date) || date.day() === 0 || date.day() === 6) &&
                                date.$D !== today.$D
                                  ? theme.picker.holiday
                                  : '',
                                {
...
export default {
  ...
  props: {
    ...
    theme: {
      ...
      default: () => ({
        background: '#343465',
        text: 'text-kimberly-primary',
        border: 'border-midnight-border',
        currentColor: 'text-kimberly-primary',
        navigation: {
          background: 'bg-midnight-light',
          hover: 'hover:bg-highlight-hover',
          focus: 'bg-highlight-hover',
        },
        picker: {
          ...
          holiday: 'text-accent-red',
          weekend: 'text-accent-green',
          event: 'bg-indigo-500',
        },
        event: {
  ...
  data() {
    ...
    const endDatepicker=dayjs(this.endDate, this.formatDate);
    ...
    const years = Array.from( Array( this.endDate? endDatepicker.diff(today, 'year') + 1 : today.diff(today, 'year') + 36,), (v, i) => {
