...
return [
    ...
    */
    ...
    'string'               => ':attribute ต้องเป็นอักขระเท่านั้น',
    ...
    'url'                  => 'ข้อมูล :attribute ต้องเป็น url ที่ถูกต้อง (ขึ้นต้นด้วย http หรือ https)',
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            ...
            'confirmed' => 'ยืนยันรหัสผ่านไม่ตรงกับรหัสผ่าน'
        ],
        'pin' => [
            'confirmed' => 'ยืนยัน PIN ไม่ตรงกัน'
        ],
    ],
